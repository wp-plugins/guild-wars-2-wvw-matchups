 ...
 * Text Domain: guild-wars-2-wvw-matchups
 * License:     GPL-2.0+
...
wp_register_style('guild-wars-2-wvw-matchups', plugins_url('style.css',__FILE__ ));
...
class wvw_matchups_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$service = new PhpGw2Api\Service(__DIR__ . '/cache', 0);
