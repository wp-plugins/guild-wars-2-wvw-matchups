...
Plugin to display the live scores of WvW matchups of Guild Wars 2.
...
1. Upload the entire `guild-wars-2-wvw-matchups` folder to the `/wp-content/plugins/` directory.
...
1. Access to widgets page to configure the plugin.
2. Widget settings for using in the sidebar.
3. Plugin display in the sidebar of a page.
